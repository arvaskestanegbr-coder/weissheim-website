          ...
          <Reveal from="right" distance={24} delayMs={100}>
            <div>
              ...
              <div className="mb-8 flex items-center gap-3">
                <span className="h-px w-10 bg-[#78684F]" />
              ...
              <h2 className="text-4xl md:text-5xl text-[#0A0A0A] leading-[1.05] mb-6">
                WEISSHEIM<br />
                Wäschesammler<br />
                <em className="text-[#0A0A0A]/50">mit System.</em>
              </h2>

              <p className="text-[15px] text-[#0A0A0A]/65 mb-10 leading-7 font-[Space_Grotesk]">
              ...
              <div className="mb-12">
                {PRODUCT_BENEFITS.map((benefit, i) => (
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#78684F] flex-shrink-0 transition-transform duration-300 group-hover/benefit:scale-150" />
